...
<h2><img src="image/homepage/categoires/fulllogo_01.png" width="70"height="65" style="float:right; margin-right:50px;margin-top:-10px">USER DASHBOARD</h2>
...
<tbody>
  <tr> 
    ...
    <h3 style="text-align:center;margin-right:50px;font-size:xx-large;color:#03045e">REGISTRATION</h3>
