...
<head>
    <title>Inverted Triangle Users</title>
...
<li class="li"><a class="active" href="search_inverted_triangle.php">INVERTED RECTANGLE</a></li>
...
?>
     ...
     <?php
            $sql="SELECT * FROM user_details WHERE body_shape='inverted triangle'";
